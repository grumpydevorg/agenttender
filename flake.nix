    ...
    let
      ...
      mkTendr =
        ...
        pkgs.rustPlatform.buildRustPackage {
          ...
          # needs the debug-only TENDR_TEST_READY_GATE readiness hold, and
          # tests/sidecar_failure.rs the fault hooks TENDR_TEST_FAIL,
          # TENDR_TEST_PANIC and TENDR_TEST_FAULT_GATE.
          checkType = "debug";
